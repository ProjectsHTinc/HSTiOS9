...
//        CCWebViewViewController.statusCode = 0
//
//        //Preparing for webview call
//        if CCWebViewViewController.statusCode == 0{
...
//        {
//            let _ = segue.destination as! AddMoneyWalletViewController
